...
@Directive({
  selector: '[ngAnimateCssGrid]'
})
export class NgAnimateCssGridDirective implements AfterViewInit, OnDestroy {

  @Input() ngAnimateCssGrid: WrapGridConfig = {};
